...
def resnet34(im_width=256, im_height=256, num_classes=9, include_top=True):
    return _resnet(BasicBlock, [3, 4, 6, 3], im_width, im_height, num_classes, include_top)


def resnet50(im_width=256, im_height=256, num_classes=9, include_top=True):
    return _resnet(Bottleneck, [3, 4, 6, 3], im_width, im_height, num_classes, include_top)


def resnet101(im_width=256, im_height=256, num_classes=9, include_top=True):
